/*
    ...
    GraceOS kernel port notes:
    - #include <stdint.h> replaced with #include "../../lib/libc/int.h"
    - #include <stdlib.h> guarded by GRACEOS_INT_H (defined via string.h->int.h chain)
    - #include <string.h> resolves to lib/libc/string.h via -Ilib/libc
    - memcpy/memset/memcmp/abs() macro shims defined in voicebox_server.c
    - MINIMP3_ONLY_MP3 defined to skip Layer 1/2 support
    - SSE2 SIMD available (kmain enables SSE before audio subsystem init)
    - Full implementation from https://github.com/lieff/minimp3 (public domain)
*/
...
#ifndef GRACEOS_INT_H  /* GraceOS: abs() provided by shims; stdlib not available */
#include "../../lib/libtranslate/stdlib.h"
#endif
